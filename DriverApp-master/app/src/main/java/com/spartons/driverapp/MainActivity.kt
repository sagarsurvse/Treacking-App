...
class MainActivity : AppCompatActivity() {
    ...
    var random = Random()
    var generatedPassword = String.format("%04d", random.nextInt(10000))
    private val firebaseHelper = FirebaseHelper(generatedPassword)
    ...
    private fun createLocationCallback() {
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(locationResult: LocationResult?) {
                ...
                if (driverOnlineFlag) firebaseHelper.updateDriver(Driver(lat = latLng.latitude, lng = latLng.longitude, driverId = generatedPassword))
